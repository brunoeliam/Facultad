...
type
  ...
  vector2= array [long2] of producto; 
...
procedure IncisoC (v: vector; var v2: vector2; var DimL: integer);
begin
	while ((v[tres] <> nil) and (DimL<30)) do begin
  	DimL:= DimL + 1;
  	v2[DimL]:= v[tres]^.dato;
  	v[tres]:=v[tres]^.sig;
  end;
...
procedure IncisoD (var v2:vector2;DimL:integer);
var 
