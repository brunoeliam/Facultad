...
public abstract class Recital {
    ...
    public Recital(String unNombre, int dimF) {
    ...
    public void agregarTema(String nombreCancion){
        vTemas[dimL] = nombreCancion;
        dimL++;
    }
    ...
    */
    public String actuar(){
        ...
        for (int i = 0; i < this.dimF; i++) {
            aux += " y ahora tocaremos "+this.vTemas[i];
        }
        return aux;
    }
